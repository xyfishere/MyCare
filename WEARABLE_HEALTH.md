...
- `health-import.js`: parse manual CSV/JSON exports and normalize records.
...
- Add a `Share health summary` control only after personal import works.
- Let users choose metric type and range: today, this week, this month.
...
- Whether to create a Supabase `health_records` table now or keep the first import local-only.
